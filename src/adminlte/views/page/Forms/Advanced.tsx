...
const Advanced: React.FC = () => {
    useEffect(() => {
        ...
        _script.src = `${process.env.PUBLIC_URL}/assets/adminlte/plugins/select2/js/select2.full.min.js`;
        _script.async = true;

        const _script1 = document.createElement('script');
        _script1.src = `${process.env.PUBLIC_URL}/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js`;
        _script1.async = true;

        const _script2 = document.createElement('script');
        _script2.src = `${process.env.PUBLIC_URL}/plugins/moment/moment.min.js`;
        _script2.async = true;

        const _script3 = document.createElement('script');
        _script3.src = `${process.env.PUBLIC_URL}/plugins/inputmask/min/jquery.inputmask.bundle.min.js`;
        _script3.async = true;

        const _script4 = document.createElement('script');
        _script4.src = `${process.env.PUBLIC_URL}/plugins/daterangepicker/daterangepicker.js`;
        _script4.async = true;

        const _script5 = document.createElement('script');
        _script5.src = `${process.env.PUBLIC_URL}/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js`;
        _script5.async = true;

        const _script6 = document.createElement('script');
        _script6.src = `${process.env.PUBLIC_URL}/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js`;
        _script6.async = true;

        const _script7 = document.createElement('script');
        _script7.src = `${process.env.PUBLIC_URL}/plugins/bootstrap-switch/js/bootstrap-switch.min.js`;
        _script7.async = true;

        const _script8 = document.createElement('script');
        _script8.src = `${process.env.PUBLIC_URL}/assets/adminlte/dist/js/pages/forms/advanced.js`;
        _script8.async = true;
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="form-group">
                                    ...
                                    <select className="form-control select2" disabled style={{ width: '100%' }}>
                                        <option selected>Alabama</option>
                                        <option>Alaska</option>
                                        <option>California</option>
                                        <option>Delaware</option>
                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="form-group">
                                    <label>Disabled</label>
                                    <select className="form-control select2bs4" disabled style={{ width: '100%' }}>
                                        <option selected>Alabama</option>
                                        <option>Alaska</option>
                                        <option>California</option>
                                        <option>Delaware</option>
                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-12">
                                <div className="form-group">
                                    <label>Multiple</label>
                                    <select className="duallistbox" multiple>
                                        <option selected>Alabama</option>
                                        <option>Alaska</option>
                                        <option>California</option>
                                        <option>Delaware</option>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="card card-primary">
                            ...
                            <div className="card-footer">
                                Visit <a href="https://tempusdominus.github.io/bootstrap-4/Usage/">tempusdominus </a>{' '}
                                for more examples and information about the plugin.
                            </div>
                            {/* /.card-body */}
                        </div>
                        ...
                        <div className="card card-success">
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <div className="form-group clearfix">
                                            ...
                                            <div className="icheck-primary d-inline">
                                                ...
                                                <label htmlFor="checkboxPrimary3">Primary checkbox</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <div className="form-group clearfix">
                                            ...
                                            <div className="icheck-danger d-inline">
                                                ...
                                                <label htmlFor="checkboxDanger3">Danger checkbox</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <div className="form-group clearfix">
                                            ...
                                            <div className="icheck-success d-inline">
                                                ...
                                                <label htmlFor="checkboxSuccess3">Success checkbox</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                            ...
                            <div className="card-footer">
                                ...
                                <a href="https://bantikyan.github.io/icheck-bootstrap/">Documentation</a>
                            </div>
                        </div>
                        {/* /.card */}
                        {/* Bootstrap Switch */}
