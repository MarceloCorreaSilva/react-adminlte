                    ...
                    <div className="row">
                        <div className="col-12 col-sm-6">
                            ...
                            <div className="col-12">
                                <img
                                    src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/prod-1.jpg`}
                            ...
                            <div className="col-12 product-image-thumbs">
                                ...
                                <div className="product-image-thumb">
                                    <img
                                        src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/prod-2.jpg`}
                                        alt="Product"
                                    />
                                </div>
                                <div className="product-image-thumb">
                                    <img
                                        src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/prod-3.jpg`}
                                        alt="Product"
                                    />
                                </div>
                                <div className="product-image-thumb">
                                    <img
                                        src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/prod-4.jpg`}
                                        alt="Product"
                                    />
                                </div>
                                <div className="product-image-thumb">
                                    <img
                                        src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/prod-5.jpg`}
                                        alt="Product"
                                    />
                                </div>
                            </div>
                    ...
                    <div className="row mt-4">
                        ...
                        <div className="tab-content p-3" id="nav-tabContent">
                            ...
                            >
                                ...
                                Sed posuere, purus at efficitur hendrerit, augue elit lacinia arcu, a eleifend sem elit
                                et nunc. Sed rutrum vestibulum est, sit amet cursus dolor fermentum vel. Suspendisse mi
                                nibh, congue et ante et, commodo mattis lacus. Duis varius finibus purus sed venenatis.
                                ...
                                velit mauris, in pellentesque urna pellentesque viverra. Nullam non pellentesque justo,
                                et ultricies neque. Praesent vel metus rutrum, tempus erat a, rutrum ante. Quisque
                                interdum efficitur nunc vitae consectetur. Suspendisse venenatis, tortor non convallis
                                interdum, urna mi molestie eros, vel tempor justo lacus ac justo. Fusce id enim a erat
                            ...
                            >
                                ...
                                laoreet. Suspendisse potenti. Donec et finibus sem, ut commodo lectus. Cras eget neque
                                dignissim, placerat orci interdum, venenatis odio. Nulla turpis elit, consequat eu eros
                                ac, consectetur fringilla urna. Duis gravida ex pulvinar mauris ornare, eget porttitor
                                enim vulputate. Mauris hendrerit, massa nec aliquam cursus, ex elit euismod lorem,
                                vehicula rhoncus nisl dui sit amet eros. Nulla turpis lorem, dignissim a sapien eget,
                            ...
                            >
                                ...
                                Aenean elementum leo augue, id fermentum risus efficitur vel. Nulla iaculis malesuada
                                scelerisque. Praesent vel ipsum felis. Ut molestie, purus aliquam placerat sollicitudin,
                                mi ligula euismod neque, non bibendum nibh neque et erat. Etiam dignissim aliquam
                                ligula, aliquet feugiat nibh rhoncus ut. Aliquam efficitur lacinia lacinia. Morbi ac
                                molestie lectus, vitae hendrerit nisl. Nullam metus odio, malesuada in vehicula at,
                                consectetur nec justo. Quisque suscipit odio velit, at accumsan urna vestibulum a. Proin
                                dictum, urna ut varius consectetur, sapien justo porta lectus, at mollis nisi orci et
                                nulla. Donec pellentesque tortor vel nisl commodo ullamcorper. Donec varius massa at
                                semper posuere. Integer finibus orci vitae vehicula placerat.{' '}
                            </div>
                        </div>
                    </div>
                </div>
