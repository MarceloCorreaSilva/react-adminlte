                                ...
                                <div className="col-12">
                                    ...
                                    <div className="post">
                                        <div className="user-block">
                                            <img
                                                ...
                                                src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/user1-128x128.jpg`}
                                                alt="user"
                                            />
                                    ...
                                    <div className="post clearfix">
                                        <div className="user-block">
                                            <img
                                                className="img-circle img-bordered-sm"
                                                src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/user7-128x128.jpg`}
                                                alt="User"
                                            />
                                            <span className="username">
                                                <a href="!#">Sarah Ross</a>
                            ...
                            <ul className="list-unstyled">
                                <li>
                                    <a href="!#" className="btn-link text-secondary">
                                        <i className="far fa-fw fa-file-word" /> Functional-requirements.docx
                                    </a>
                                </li>
                                <li>
                                    <a href="!#" className="btn-link text-secondary">
                                ...
                                <li>
                                    <a href="!#" className="btn-link text-secondary">
                                        <i className="far fa-fw fa-envelope" /> Email-from-flatbal.mln
                                    </a>
                                </li>
                                <li>
                                    <a href="!#" className="btn-link text-secondary">
                                        <i className="far fa-fw fa " /> Logo.png
                                    </a>
                                </li>
                                <li>
                                    <a href="!#" className="btn-link text-secondary">
                                        <i className="far fa-fw fa-file-word" /> Contract-10_12_2014.docx
                                    </a>
                                </li>
                            </ul>
