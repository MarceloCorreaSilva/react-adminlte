                        ...
                        <div className="invoice p-3 mb-3">
                            ...
                            <div className="row">
                                ...
                                <div className="col-6">
                                    ...
                                    <img
                                        src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/credit/visa.png`}
                                        alt="Visa"
                                    />
                                    <img
                                        src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/credit/mastercard.png`}
                                        alt="Mastercard"
                                    />
                                    <img
                                        src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/credit/american-express.png`}
                                        alt="American Express"
                                    />
                                    <img
                                        src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/credit/paypal2.png`}
                                        alt="Paypal"
                                    />
