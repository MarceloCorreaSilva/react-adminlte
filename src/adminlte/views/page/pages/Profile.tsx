                            ...
                            <div className="card-body box-profile">
                                <div className="text-center">
                                    <img
                                        ...
                                        src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/user4-128x128.jpg`}
                                        alt="User profile"
                                    />
                                </div>
                                    ...
                                    <div className="active tab-pane" id="activity">
                                        ...
                                        <div className="post">
                                            <div className="user-block">
                                                <img
                                                    className="img-circle img-bordered-sm"
                                                    src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/user6-128x128.jpg`}
                                                    alt="User"
                                                />
                                                <span className="username">
                                                    <a href="!#">Adam Jones</a>
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-6">
                                                            <img
                                                                className="img-fluid mb-3"
                                                                src={`${process.env.PUBLIC_URL}/assets/adminlte/dist/img/photo4.jpg`}
                                                                alt="Cover 3"
                                                            />
                                                            <img
                                                                className="img-fluid"
