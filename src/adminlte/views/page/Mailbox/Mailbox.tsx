...
const Mailbox: React.FC = () => {
    useEffect(() => {
        ...
        _script.src = `${process.env.PUBLIC_URL}/assets/adminlte/dist/js/pages/mailbox/mailbox.js`;
        _script.async = true;
        ...
        <Layout title="Inbox">
            <div className="row">
                <div className="col-md-3">
                    <a href="/mailbox/compose" className="btn btn-primary btn-block mb-3">
                        Compose
                    </a>
                    <div className="card">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="mailbox-name">
                                                <a href="/mailbox/read-mail">Alexander Pierce</a>
                                            </td>
