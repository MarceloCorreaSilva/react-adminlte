                                ...
                                <table className="table table-bordered text-center">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-default btn-sm">
                                                    Default
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-secondary btn-lg">
                                                    Secondary
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" className="btn btn-block btn-secondary btn-sm">
                                                    Secondary
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" className="btn btn-block btn-secondary btn-xs">
                                                    Secondary
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" className="btn btn-block btn-secondary btn-flat">
                                                    Secondary
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-success btn-lg">
                                                    Success
                                                </button>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-success btn-xs">
                                                    Success
                                                </button>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-info btn-xs">
                                                    Info
                                                </button>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-info disabled">
                                                    Info
                                                </button>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-danger btn-flat">
                                                    Danger
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" className="btn btn-block btn-danger disabled">
                                                    Danger
                                                </button>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-warning btn-sm">
                                                    Warning
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" className="btn btn-block btn-warning btn-xs">
                                                    Warning
                                                </button>
                                            </td>
                                            <td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-primary btn-flat"
                                                >
                                                    Primary
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-secondary btn-xs"
                                                >
                                                    Secondary
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-success btn-flat"
                                                >
                                                    Success
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-outline-info btn-lg">
                                                    Info
                                                </button>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button type="button" className="btn btn-block btn-outline-info btn-xs">
                                                    Info
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-info btn-flat"
                                                >
                                                    Info
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-info disabled"
                                                >
                                                    Info
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-danger btn-flat"
                                                >
                                                    Danger
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-danger disabled"
                                                >
                                                    Danger
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-warning btn-lg"
                                                >
                                                    Warning
                                                </button>
                                            </td>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-warning btn-xs"
                                                >
                                                    Warning
                                                </button>
                                            </td>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block btn-outline-warning disabled"
                                                >
                                                    Warning
                                                </button>
                                            </td>
                            ...
                            <div className="card-body pad table-responsive">
                                ...
                                <table className="table table-bordered text-center">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <button type="button" className="btn btn-block bg-gradient-primary">
                                                    Primary
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-primary btn-lg"
                                                >
                                                    Primary
                                                </button>
                                            </td>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-primary btn-flat"
                                                >
                                                    Primary
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-primary disabled"
                                                >
                                                    Primary
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <button type="button" className="btn btn-block bg-gradient-secondary">
                                                    Secondary
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-secondary btn-lg"
                                                >
                                                    Secondary
                                                </button>
                                            </td>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-secondary btn-xs"
                                                >
                                                    Secondary
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-secondary btn-flat"
                                                >
                                                    Secondary
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-secondary disabled"
                                                >
                                                    Secondary
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <button type="button" className="btn btn-block bg-gradient-success">
                                                    Success
                                                </button>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-success btn-xs"
                                                >
                                                    Success
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-success btn-flat"
                                                >
                                                    Success
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-success disabled"
                                                >
                                                    Success
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <button type="button" className="btn btn-block bg-gradient-info">
                                                    Info
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" className="btn btn-block bg-gradient-info btn-lg">
                                                    Info
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" className="btn btn-block bg-gradient-info btn-sm">
                                                    Info
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" className="btn btn-block bg-gradient-info btn-xs">
                                                    Info
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-info btn-flat"
                                                >
                                                    Info
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-info disabled"
                                                >
                                                    Info
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <button type="button" className="btn btn-block bg-gradient-danger">
                                                    Danger
                                                </button>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-danger btn-flat"
                                                >
                                                    Danger
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-danger disabled"
                                                >
                                                    Danger
                                                </button>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <button type="button" className="btn btn-block bg-gradient-warning">
                                                    Warning
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-warning btn-lg"
                                                >
                                                    Warning
                                                </button>
                                            </td>
                                            ...
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-warning btn-flat"
                                                >
                                                    Warning
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    type="button"
                                                    className="btn btn-block bg-gradient-warning disabled"
                                                >
                                                    Warning
                                                </button>
                                            </td>
                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <button type="button" className="btn btn-default btn-block btn-flat">
                                    .btn-block .btn-flat
                                </button>
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <p>
                                    Add the classes <code>.btn.btn-app</code> to an <code>&lt;a&gt;</code> tag to
                                    achieve the following:
                                </p>
                                <a href="!#" className="btn btn-app">
